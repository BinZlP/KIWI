...
// 총 게시물 수 를 구한다.
$result_count=$db_connect -> query("SELECT count(*) FROM board");
foreach($result_count as $result_row){}
...
<tr>
    ...
    <!-- 날짜 -->
    <td align=center height=20 bgcolor=white>
        <font color=black><?php$row[written_date]?></font>
    </td>
    <!-- 날짜 끝 -->
    <!-- 조회수 -->
    <td align=center height=20 bgcolor=white>
