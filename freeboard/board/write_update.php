...
//글 등록
	...
	$sql = 'insert into board_free (b_no, b_title, b_content, b_date, b_hit, b_id, b_password, b_class) values(null, "' . $bTitle . '", "' . $bContent . '", "' . $date . '", 0, "' . $bID . '", password("' . $bPassword . '")' . $b_class .')';
	$msgState = '등록';
}
